...
class WorkGraphicTest < ActiveSupport::TestCase
  ...
  test "should return image url" do
    ...
    assert @first_work_graphic.graphic_file.include? '/system/graphics/980190962/original/rails.png', 'Wrong file path'
  end

  test "should return image json with image url" do
    assert_not_nil @first_work_graphic.graphic_file
    assert @first_work_graphic.as_json["work_graphic"][:graphic_file].include? '/system/graphics/980190962/original/rails.png', 'Wrong file path'
  end
